...
contract FundMe {
    ...
    //s_ tells it is storage variable, i_ tells it is not getting stored in storage
    address private immutable i_Owner;
    uint256 public constant MINIMUM_USD = 50 * 10 ** 18; //name contant values with capslock
    modifier onlyOwner() {
